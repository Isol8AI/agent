...
const SESSION_TARGET_FIELDS_BY_METHOD = new Map<string, readonly SessionMutationTargetField[]>([
  ...
  ["controlUi.sessionPreview", ["sessionKey"]],
  ...
  ["sessions.execution.dispatch", ["sessionKey"]],
  ["sessions.presence.heartbeat", ["sessionKey"]],
  ["sessions.presence.snapshot", ["sessionKey"]],
  ["sessions.presence.subscribe", ["sessionKey"]],
  ["sessions.presence.unsubscribe", ["sessionKey"]],
  ["sessions.steer", ["key"]],
  ["sessions.usage", ["key"]],
  ["sessions.usage.timeseries", ["key"]],
  ["sessions.usage.logs", ["key"]],
